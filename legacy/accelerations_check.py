...
launch_site = main.LaunchSite(rail_length=10, rail_yaw=0, rail_pitch=0, alt=0, longi=0, lat=0, wind=[0,0,0], atmosphere=StandardAtmosphere)
...
print(martlet4.acceleration(martlet4.pos, martlet4.v, martlet4.w, martlet4.time))

#It's putting in a vector of NAN somewhere for body_to_inertial(vector)
