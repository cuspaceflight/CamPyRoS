...
launch_site_vars={"rail_length":[10,.1], "rail_yaw":[0,0.03], "rail_pitch":[0,0.03], "alt":[0,1], "longi":[0,0.01], "lat":[0,0.01], "wind":[np.array([0,0,0]),1]}
...
launch_site_vars={"rail_length":[10,0.0], "rail_yaw":[0,0.0], "rail_pitch":[0,0.0], "alt":[0,0], "longi":[0,0.0], "lat":[0,0.0], "wind":[np.array([0,0,0]),0]}
motor_base = trajectory.Motor(motor_time_data, prop_mass_data, cham_pres_data, throat_data, gamma_data, nozzle_efficiency_data, exit_pres_data, area_ratio_data)
thrust_error = 0.0
...
model.run_model(1000,save_loc="nominal")