...
pickle.dump([motor_time_data,prop_mass_data,cham_pres_data,throat_data,gamma_data,nozzle_efficiency_data,exit_pres_data,area_ratio_data], open('novus_sim_6/motor_out.pkl', 'w'))