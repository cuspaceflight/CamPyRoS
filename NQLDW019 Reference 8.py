...
ax1.plot(time_data, analysis.q_lam[9, :], label="QLAM (Python)", color="blue", linestyle="--")
ax1.plot(qlam_data["x"], qlam_data["y"], label="QLAM (NASA)", color="blue")
ax1.plot(time_data, analysis.q_turb[9, :], label="QTURB (Python)", color="red", linestyle='--')
ax1.plot(qturb_data["x"], qturb_data["y"], label="QTURB (NASA)", color="red")

ax1.set_xlabel("Time (s)")
ax1.set_ylabel("Heat transfer rate (W/m^2)")
ax1.grid()
ax1.legend()
