...
launch_site = main.LaunchSite(rail_length=5, rail_yaw=10, rail_pitch=20, alt=0, longi=0, lat=0, wind=[0,0,0], atmosphere=StandardAtmosphere)
parachute=main.Parachute(13.9,0.78,1.13,0.78,1000,0)
'''Create the Rocket object'''
martlet4 = main.Rocket(mass_model, pulsar, aerodynamic_coefficients, launch_site, h=0.05, variable=True,alt_poll_interval=1)
