...
launch_site = main.LaunchSite(rail_length=5, rail_yaw=0, rail_pitch=0.4, alt=0, longi=0, lat=0, wind=[0,0,0], atmosphere=StandardAtmosphere)
...
main.plot_launch_trajectory_3d(simulation_output, show_orientation=True, show_aero=True)
