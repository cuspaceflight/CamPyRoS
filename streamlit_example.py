...
aero_file = st.text_input("Enter RASAero datafile location")#"data/Martlet4RasAeroII.CSV"
if aero_file != "":
    aerodynamic_coefficients = trajectory.RasAeroData(aero_file)
    ...
    plot=st.pyplot(trajectory.plot_altitude_time(imported_data,martlet4))

    # Streamlit widgets automatically run the script from top to bottom. Since
    # this button is not connected to any other logic, it just causes a plain
    # rerun.
st.title("CUSF 6 DoF Rocket Trajectory Simulation")
st.button("Re-run")