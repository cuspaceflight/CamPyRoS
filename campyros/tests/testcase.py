...
motor_csv = pd.read_csv("testmotor.csv")
...
aero_data = pyro.AeroData.from_rasaero(
    "testaero.csv", REF_AREA, C_DAMP_PITCH, C_DAMP_ROLL
)
...
pulsar = pyro.Motor.from_novus("testmotor.csv", pos=ROCKET_L)
...
"""Run the simulation"""
simulation_output = martlet4.run(debug=True, to_json="test.json")
